# Introduction
      ...
      SHIP SHEET
       ...
       Length: 			               Draft: 			                Skill Used:

       Movement:



        Normal Crew:                           Skeleton Crew (–20%):

        Overcrewed (+10%)                      Prize Crew (–10%):

        Crew needed for guns:                  Boarding Party:
       ...
       WEAPONS
        ...
        Fore:              Aft     Broadside         Broadside           Broadside
       ...
       Cargo:		            ton
        ...
        piracy and plunder
         ...
         11–15           Relatively Calm – roll on the Random Weather table with a +2 bonus. The
                         weather persists for 1D6 days
         16–19           Violent – roll on the Random Weather table with a +4 bonus. The weather
                         persists for one day.
         20+             Storm. The storm lasts 2D20 hours; reroll on the Random Weather Change
      ...
      Encounters At Sea
       ...
       Encounters at Sea
       Roll                  Settled      Wild          Open     Trade
       (2D6)    Near Port    Coast        Coast         Seas     Route    Backwater High Seas
       2 or     Merchant     Merchant     Merchant      Merchant Merchant Merchant Merchant
       less     +4           +2
       3        Merchant     Merchant     Local         Local       Merchant Local         No
                +2                                                                         encounter
       4        Merchant     Local    No                No          Merchant    No         No
                                      encounter         encounter               encounter encounter
       5        Local       No        No                No          No          No         No
                            encounter encounter         encounter   encounter   encounter encounter
       6        Event on    Event on Event on           Event on    Event on    Event on   Event on
                ship        ship      ship              ship        ship        ship       ship
       7        Strangeness No        No                No          No          No         No
                on Shore    encounter encounter         encounter   encounter   encounter encounter
       8        Event on    Event on Event on           Event on    Event on    Event on   Event on
                ship*       ship*     ship*             ship*       ship*       ship*      ship*
       9        Local       No        No                No          No          No         No
                            encounter encounter         encounter   encounter   encounter encounter
       10       Local +2    Local     No                No          Merchant    No         No
                                      encounter         encounter               encounter* encounter
       11       Naval       Strange   Strangeness       Local       Naval       No         No
                vessel or   ness on   on shore                      Vessel or   encounter* encounter*
                Pirate      shore                                   Pirate
       12+      Naval       Naval     Random            Naval       Naval       Naval         Naval
                vessel +2   Vessel or Vessel            vessel or   Vessel +2   Vessel        Vessel
                            Pirate                      Pirate
       ...
       * The crew must make a Morale test due to boredom or adverse events.
        ...
        Next, roll on the appropriate table for the encounter.
         ...
         Roll 2D6      Event
         2             Fire! A fire breaks out aboard ship. It is initially only a small fire but can quickly
                       grow if not dealt with.
         3             Disease! Disease strikes down the crew. See Disease.
         4             Water Spoiled! Some of the ship’s water supplies have become foul and
                       undrinkable. Roll 1D6 x 10% to see how much water is lost.
         5             Drunkenness! Several people on the ship are drunk. The crew suffers a –10%
                       penalty to Shiphandling tests today.
         6             Gambling! A high-stakes game of cards or knucklebones is being played on ship.
         7             Quarrelling! Several crew are fighting amongst themselves. The crew suffers a
                       –10% penalty to Shiphandling tests today. Furthermore, 1D6 crew members are
                       injured. On a natural 6, one has been killed.
         8             Supplies Spoiled! Some of the ship’s food supplies have become foul and
                       undrinkable. Roll 1D6 x 5% to see how much food is lost.
         9             Man Overboard! One of the crew has fallen overboard! Roll 1D6 – on a 6, it is
                       one of the officers.
         10            Good Fortune! The crew has the devil’s own luck. Either raise Morale by one
                       level, or have a free Improvement roll.
         11            Dissent! The crew must make another Morale test.
         12            Accident! A spar crashes to the deck, a cannon tears itself loose and slides into a
         ...
         Roll 2D6 Event
         2        Shipwreck sighted! The Adventurers come upon a shipwreck. Roll upon the
         ...
         3        Flotsam! The Adventurers find some wreckage from a destroyed ship. Roll on the
                  Random Vessel table to see what it was. There may be some salvage here – roll
                  1D4–2 times on the vessel’s Plunder table.
         4        Fire! The Adventurers see a plume of smoke from inland… it could be a cooking
         ...
         12       Castaway found! The characters encounter a castaway from another ship, desperate
...
combat on the high seas
    ...
    Ranged Attacks
     ...
     The pirates have no applicable modifiers to their Hand to Hand score.
      ...
      The pirates fail their test, so they suffer 1D6 casualties, +1 for the +1 Running Wounds Total still
         ...
         Inspiring the crew through conspicuous        Re-roll a failed Morale test
         bravery
         Duelling the opponent’s leader                +5% Hand to Hand
         Leading a few crack gunners to catch the      +5% Firearms
         foe in a crossfire
         Saving a wounded crewmate                     –2 to the next damage roll made against your
                                                       crew
         Throwing yourself into the fight              +2 to the next damage roll made against the
                                                       enemy
      ...
      Destroying Ships
       ...
       Critical Hits
       Roll        Damage
       1–2         Mast Topples – one of the ship’s masts falls, halving its Movement, giving a –50%
                   penalty to Shiphandling tests and dealing 4D6 Structure Points of damage
       3           Sail Falls – one of the ship’s sails plummets to the deck, halving its Movement,
                   giving a –50% penalty to Shiphandling tests and adding 1D6 to the Crew’s
                   Running Wounds Total.
       4–5         Rigging Damaged – the ship’s rigging is damaged, preventing it from changing sail
                   and giving a –20% penalty to Shiphandling tests.
       6           Crew Maimed – the attack tears through the crew on deck, adding 2D6 to the
                   Crew’s Running Wounds Total.
       7           Officer Struck – one of the officers is hit by the cannon ball. If he is an
       ...
       20          Magazine Struck: Roll 1D6. On a 4+, the powder explodes, destroying the ship
                   from the inside.
   ...
   Port Qualities
       ...
       Pirate         ~1,000         A few cannon,            None     1D4 Pirate
                                     wooden fort
       Local          ~500           1D6 9 or 18-pounder      25         1D4 Local      5x4D6
                                     cannon, wall             troops                    Common,
                                                                                        2x2D6 Rare,
                                                                                        50% chance of
                                                                                        1D4 Treasures
       Minor          ~2,000         2D6 18-pounder           100        2D4 Local,     10x4D6
                                     cannon, fortified        troops     1 Merchant     Common,
                                     house                                              5x2D6 Rare,
                                                                                        1D4 Treasures
       Major          ~5,000         2D6 24 pounder           250        2D6 Local,     10x8D6
                                     cannon, tower            troops     1D6            Common,
                                                                         Merchant       5x4D6 Rare,
                                                                                        2D4 Treasures
       Fortress       ~25,000        3D6 24 pounder           2,000      3D6 Local,     20x8D6
                                     cannon, 1D6              troops     2D6            Common,
                                     45-pounder cannon,                  Merchant,      6x8D6 Rare,
                                     fortress wall                       1D6 Naval      3D4 Treasures
...
pirate attacks, of course). The Adventurers have to battle their foe’s minions and expose his pirate
   ...
   Scurvy Dogs and Other Rogues
       ...
        
        ...
        Movement                        4m
        Strike Rank                     +10                Skills: Acrobatics 25% (22%), Athletics 35% (32%),
     ...
     Pirate, Devilish Cut-Throat
         ...
          
          ...
          Magic Points                    0                  Equipment: Dagger, Cutlass, Musket, Two Pistols,
                                                             Grenade, Compass
          Movement                        4m
          Strike Rank                     +11                Skills: Acrobatics 32% (29%), Athletics 51% (48%),
     ...
     Pirate, Quartermaster
         ...
          
          ...
          Movement                     4m
          Strike Rank                  +17                   Skills: Acrobatics 25% (22%), Athletics 56% (53%),
     ...
     Pirate Captain
       ...
       Movement                   4m
       Strike Rank                +13             Skills: Athletics 36% (31%), Boating 23%, Evade 76%
...
Town Guard
       ...
       Movement                     4m
       Strike Rank                  +10             Skills: Athletics 33% (26%), Craft (any one) 30%,
  ...
  Fat Merchant
         ...
         Movement                 4m
         Strike Rank              +11              Skills: Courtesy 52%, Evaluate 65%, Influence 68%,
...
Governor
       ...
       Magic Points              0                Equipment: Rapier, Fine Clothes, Pistol, 4D10x100
                                                  Silver
       Movement                  4m
       Strike Rank               +12              Skills: Courtesy 60%, Dance 30%, Influence 75%,
...
Governor’s Daughter
         ...
         Movement                 4m
         Strike Rank              +14               Skills: Courtesy 60%, Craft (needlework) 34%,
...
Sailor
         ...
         Movement                 4m
         Strike Rank              +10             Skills: Acrobatics 35%, Athletics 43%, Boating 38%,
...
Officer of the Royal Navy
       Seasoned. 
        ...
        Movement                       4m
        Strike Rank                    +12        Skills: Acrobatics 25% (22%), Athletics 43% (40%),
       ...
       Advanced Skills	                          11   Crew Skill Tests	                    38
       Adventurer Generation	                     3   Critical Hits on Ships	              96
       Aftermath	                                88   Cruelty	                             26
       Aftermath of Battles	                     96   Customising and Changing a Ship	     56
       Ammunition	                               33   Daily Checklist	                     64
       Avarice	                                  25   Dangers	                             60
       Barge	                                    48   Dashing		                            22
       Barque	                                   48   Destroying Ships	                    96
       Battle Stations!	                         91   Destruction	                         26
       Beaching a Ship	                          61   Devil’s Luck	                        22
       Blasphemy	                                25   Disease	                             60
       Boarding Actions	                         90   Drink	                               26
       Boarding Actions	                         95   Drowned Man	                         23
       Born to the Sea		                         22   Duels	                               79
       Bravado	                                  26   Duel Summary	                        83
       Brigantine	                               48   Duels with Multiple Participants	    81
       Buccaneers and Privateers	               102   Elections	                           39
       Buying a Ship	                            55   Encounters At Sea	                   66
       Campaign Ideas	                          105   Entering a Port	                     98
       Cannons	                                  89   Equipment	                           35
       Canoe	                                    48   Fat Merchant	                       117
       Captains, Quartermasters and Officers	    41   Fearsome Aura	                       23
       Captured Pirates	                        100   Fire	                                60
       Careening	                                61   Firing	                              93
       Changes from the Legend Ship Rules	       48   Fishing Boat	                        49
       Chases	                                   92   Fluyt	                               49
       Cinematic Piracy	                        105   Food & Drink	                        35
       Clockwork Equipment	                     108   Formal Duels	                        82
       Clothing	                                 34   Freedom	                             27
       Common Plunder	                           76   Frigate	                             49
       Contact	                                  22   Gaining Advantage	                   80
       Cooking (INT+POW)	                        11   Galleon	                             49
       Corvette	                                 49   Gambling	                            27
       Cost of Repair	                           59   Gluttony	                            27
       Cover & Fortifications	                   85   Governor	                           118
       Cowardice	                                26   Governor’s Daughter	                119
       Crew Combat	                              83   Gunnery (INT+DEX)	                   11
       Crew Quality	                             36   Handiwork (INT)	                     12
       Crew Size & Crew Tests	                   48   Hand to Hand Attacks	                87



Hand to Hand Combat Modifiers	           87   Reputation	                           17
         Healing Damage To A Crew	                44   Resetting Advantage	                  81
         Heroic Actions	                          89   Revenge	                              28
         Historical Piracy	                      101   Reversing Advantage	                  81
         Honour	                                  27   Rowboat	                              50
         Improvement	                             43   Rowing	                               52
         Indiaman	                                49   Running Aground	                      61
         Infamous	                                23   Sailing	                              53
         Legendary Abilities	                     19   Sail Modifiers	                       54
         Lust	                                    27   Sailor	                              121
         Manoeuvring 	                            93   Schooner	                             50
         Melee Weapons	                           29   Seaworthiness	                        59
         Minor Loa	                              107   Seduction	                            28
         Modifications	                           56   Selling Off Your Ill-Gotten Gains	    98
         Morale	                                  38   Ship Qualities: Optional Rule	        52
         Morale Bonuses	                          39   Ship Statistics	                      46
         Morale Tests	                            39   Ship to Ship Combat	                  91
         Morale Tests	                            88   Sieges	                               91
         Movement	                                52   Sighting Ships	                       92
         Mutinies	                                43   Sinking Ships	                        95
         Old Salt	                                23   Sloop	                                50
         Optional Rule: Fatigue in Pirates Games	 82   Small Trader	                         50
         Optional Rule: Fighting Aboard Ship	     80   Snow	                                 50
         Otherworldly Piracy	                    109   Special Crew Combats	                 89
         Overloading	                             47   Starting Money	                        4
         Part 0: Initial Concept	                  3   Step One: Crew	                       69
         Part 1: Characteristics	                  3   Step Two: Details	                    70
         Part 2: Attributes	                       3   Storms	                               60
         Part 3: Basic Skills	                     3   Structure Points	                     60
         Part 4: Previous Experience	              4   Supernatural Piracy	                 106
         Pet	                                     23   Superstitious	                        28
         Piety	                                   28   Techniques	                          104
         Pirate Activity Modifiers	               65   Temporary Measures	                   58
         Pirate Captain	                         114   The Caribbean	                       103
         Pirate, Devilish Cut-Throat 	           111   The Golden Age of Piracy	            103
         Pirate Duels	                            82   The Law	                              99
         Pirate, Quartermaster	                  113   Town Guard	                          116
         Pirate, Scurvy Dog	                     110   Trade	                                99
         Pistol Duels	                            83   Using Advantage	                      81
         Plunder	                                 75   Using Reputation	                     18
         Powder Monkey	                           23   Vapouring	                            95
         Professional Tools	                      35   Vessel Damage	                        59
         Quick Reload	                            24   Vice	                                 24
         Raft	                                    50   Warship	                              50
         Raising Morale	                          44   Weapons	                              54
         Random Starting Equipment	               14   Weather	                              63
         Ranged Attacks	                          86   Wine, Whiskey and Rum	                27
         Ranged Combat Modifiers	                 85   Witty Repartee	                       80
         Recompense For Damage	                   44   Wrath	                                28
         Repairs at Sea	                          59   Your Starting Ship	                   47
