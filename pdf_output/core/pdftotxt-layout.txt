...
                                                            player
    ...
    CHARACTERISTICS & ATTRIBUTES                                                             19-20: Head
     ...
     CON
                                                                                    16-18: L.Arm
                            improvement modifier             13-15: R.Arm             AP / HP              armour penalty:
     SIZ                                                       AP / HP
                                                                         7-9: Abdomen
                                     movement                               AP / HP
                                                                                                              GRIMOIRES
     ...
     Perception        INT+POW
     Persistence       POW x2
     Resilience        CON x2                               COMBAT STYLES
     Ride              DEX+POW
     Sing              CHA+POW                     Combat Style        Basic Percentage       %
     Sleight           DEX+CHA
     Stealth           DEX+INT
     Swim              STR+CON
     Unarmed           STR+DEX
...
                    Legend & Open Content
        ...
        scenarios and mechanics. You can even print and sell such work, if that is your desire (and we
         ...
         By using the Open Content of this book, you also have permission to download the Legend
           Compatible logo from our web site (on the Legend product pages), and use that on any
         Legend work you publish, to demonstrate your material is part of the wider Legend family.
